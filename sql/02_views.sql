...
variacao_media_mercado AS (
    SELECT
        data_referencia,
        -- Agora o LAG funciona perfeitamente sobre valores únicos mensais
    ...
    FROM
        -- Primeiro, pegamos apenas um valor de média por mês para evitar repetições
...
SELECT
    ...
    -- Colunas pivotadas para cada grupo econômico.
...
-- Juntamos o resultado da variação do mercado com a variação individual
JOIN
